...
static const std::string PROJECT_NAME = "rz_convert_image";
static const std::string PROG_LONGNAME = "Convert arbitrary image files to avif or webp in multiple sizes.";
static const std::string PROJECT_DESCRIPTION = "Convert arbitrary image files to avif or webp in multiple sizes";

static const std::string PROJECT_EXECUTABLE = "rz_convert_image";
...
static const std::string PROJECT_HOMEPAGE_URL = "https://github.com/Zheng-Bote/rz_convert_image";
